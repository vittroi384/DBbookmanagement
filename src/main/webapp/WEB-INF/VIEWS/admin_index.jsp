...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container px-5">
            <a class="navbar-brand" href="/admin_index">MNU Library Admin Page</a>
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link" href="/member_index">member page</a></li>
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="/admin_index">어드민 홈</a></li>
    ...
    <div class="container px-4 px-lg-5">
        ...
        <div class="row gx-4 gx-lg-5 align-items-center my-5">
            ...
            <div class="col-lg-5">
                <h1 class="font-weight-light">MNU Library<br /> Admin Page</h1>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템에<br /> <b>도서를 추가/삭제</b>하는 기능을 이용합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템에<br /> <b>도서의 정보를 수정</b>하는 기능을 이용합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템에<br /> <b>연체된 도서 정보를</b> 보는 기능을 이용합니다.</p>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템의<br /> <b>공지사항 게시판</b>을 관리합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템의<br /> <b>사서 추천 도서 게시판</b>을 관리합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템의<br /> <b>자유 게시판 게시물</b>을 관리합니다.</p>
                            ...
                            <div class="card-group">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템의<br /> <b>전체 회원 목록</b>을 확인합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 회원들이 신청한<br /> <b>희망 도서</b>를 확인합니다.</p>
                                ...
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">MNU Library 의 도서 시스템의<br /> <b>블랙리스트 회원 정보</b>를 관리합니다.</p>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-4 px-lg-5">
                <p class="m-0 text-center text-white">Copyright &copy; MNU Library</p>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
