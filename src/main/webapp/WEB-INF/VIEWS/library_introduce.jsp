                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-3 mb-4 mb-lg-0" href="https://github.com/vittroi384"><img class="app-badge" src="assets/img/git.png" alt="..." /></a>
                        	<a class="me-lg-3 mb-4 mb-lg-0" href="https://github.com/vittroi384"><img class="app-badge" src="assets/img/git2.png" alt="..." /></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
    ...
    <footer class="bg-black text-center py-5">
        <div class="container px-5">
            <div class="text-white-50 small">
                <div class="mb-2">&copy; MNU
						Library. All Rights Reserved.</div>
            </div>
        </div>
    </footer>
